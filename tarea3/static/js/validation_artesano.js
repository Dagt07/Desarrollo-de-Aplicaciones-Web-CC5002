...
const validateForm = () => {
  ...
  if (!isValid) {
    ...
    confirmationMessageElem.innerText = "¿Confirma el registro de este artesano?";
...
clickgotomenu = () => {
  ...
  let form = document.getElementById("form_artesano");
  form.submit();
};

clickgotoform = () => {
  window.location.href = "/agregar-artesano";
};
